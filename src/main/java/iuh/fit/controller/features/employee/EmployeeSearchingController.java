...
public class EmployeeSearchingController {
    ...
    private void handleSearchAction() {
        try {
            ...
            Gender gder = ((RadioButton) gender.getSelectedToggle()).getText().equals(Gender.MALE.toString()) ? Gender.MALE : Gender.FEMALE;
            LocalDate dob =  DOBPicker.getValue();
            String cardID = cardIDTextField.getText().isBlank() ? null : cardIDTextField.getText().trim();
            Position position = ConvertHelper.positionConverter(positionCBox.getSelectionModel().getSelectedItem());
