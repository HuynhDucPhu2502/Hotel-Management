...
IF EXISTS (SELECT name FROM sys.databases WHERE name = 'HotelTestDatabase')
BEGIN
...
-- Tạo procedure trả phòng sớm
-- (procedure không hỗ trợ sinh nextID mới)
CREATE PROCEDURE RoomCheckingOutEarly(
    @reservationFormID NVARCHAR(15),
    @employeeID NVARCHAR(15),
    @roomCharge MONEY,
    @serviceCharge MONEY,
...
BEGIN
    BEGIN TRY
        ...
        -- Cập nhật ReservationForm: đặt `RoomBookingDeposit` về 0 và cập nhật `checkOutDate`
        UPDATE ReservationForm
        SET
            RoomBookingDeposit = 0,
        ...
        VALUES (
            @roomID,
            @reservationFormID,
            CONCAT(N'Check-out sớm thành công cho phòng ', @roomID),
            'CHECKOUT',
            GETDATE()
        );
...
VALUES
	...
	('V2311', N'AVAILABLE', '2024-09-28 10:00:00', 'RC-000002'),
	('V2312', N'AVAILABLE', '2024-09-28 10:00:00', 'RC-000002'),
	('V2313', N'AVAILABLE', '2024-09-28 10:00:00', 'RC-000002'),
	('V2314', N'AVAILABLE', '2024-09-28 10:00:00', 'RC-000001'),
	('V2315', N'AVAILABLE', '2024-09-28 10:00:00', 'RC-000001'),
	('V2316', N'AVAILABLE', '2024-09-28 10:00:00', 'RC-000001');
GO
